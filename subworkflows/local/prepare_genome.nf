...
include { BEDTOOLS_COMPLEMENT as BLACKLIST_BEDTOOLS_COMPLEMENT } from "../../modules/nf-core/bedtools/complement"
include { BEDTOOLS_INTERSECT as BLACKLIST_BEDTOOLS_INTERSECT   } from "../../modules/nf-core/bedtools/intersect"
include { BEDTOOLS_SORT as ANNOTATION_BEDTOOLS_SORT            } from "../../modules/local/for_patch/bedtools/sort"
include { BEDTOOLS_SORT as BLACKLIST_BEDTOOLS_SORT             } from "../../modules/local/for_patch/bedtools/sort"
include { BOWTIE2_BUILD as BOWTIE2_BUILD_SPIKEIN               } from "../../modules/nf-core/bowtie2/build"
include { BOWTIE2_BUILD as BOWTIE2_BUILD_TARGET                } from "../../modules/nf-core/bowtie2/build"
include { CUSTOM_GETCHROMSIZES as SPIKEIN_CHROMSIZES           } from "../../modules/nf-core/custom/getchromsizes"
include { CUSTOM_GETCHROMSIZES as TARGET_CHROMSIZES            } from "../../modules/nf-core/custom/getchromsizes"
include { GTF2BED                                              } from "../../modules/local/gtf2bed"
include { GUNZIP as GUNZIP_BED                                 } from "../../modules/nf-core/gunzip"
include { GUNZIP as GUNZIP_FASTA                               } from "../../modules/nf-core/gunzip"
include { GUNZIP as GUNZIP_GTF                                 } from "../../modules/nf-core/gunzip"
include { GUNZIP as GUNZIP_SPIKEIN_FASTA                       } from "../../modules/nf-core/gunzip"
include { SAMTOOLS_FAIDX                                       } from "../../modules/nf-core/samtools/faidx"
include { TABIX_BGZIPTABIX                                     } from "../../modules/nf-core/tabix/bgziptabix"
include { UNTAR as UNTAR_INDEX_SPIKEIN                         } from "../../modules/nf-core/untar"
include { UNTAR as UNTAR_INDEX_TARGET                          } from "../../modules/nf-core/untar"
...
workflow PREPARE_GENOME {
    ...
    */
    ch_tabix = ch_gene_bed.map { row ->
        [[id: row.getName()], row]
    }

    if (params.gene_bed && params.gene_bed.endsWith(".gz")) {
        ch_tabix = ch_tabix.map { row ->
            [[id: row[0].id.split("\\.")[0]], row[1]]
        }
    }
