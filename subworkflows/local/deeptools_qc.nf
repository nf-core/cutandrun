...
include { DEEPTOOLS_MULTIBAMSUMMARY } from '../../modules/nf-core/deeptools/multibamsummary'
include { DEEPTOOLS_PLOTCORRELATION } from '../../modules/nf-core/deeptools/plotcorrelation'
include { DEEPTOOLS_PLOTFINGERPRINT } from '../../modules/nf-core/deeptools/plotfingerprint'
include { DEEPTOOLS_PLOTPCA         } from '../../modules/nf-core/deeptools/plotpca'
...
workflow DEEPTOOLS_QC {
    ...
    */
    DEEPTOOLS_PLOTFINGERPRINT(ch_bam_bai)
