...
def nextflow_runtime(
    ...
    save_spikein_aligned: typing.Optional[bool],
    save_unaligned: typing.Optional[bool],
    save_align_intermed: typing.Optional[bool],
    email: typing.Optional[str],
    dump_scale_factors: typing.Optional[bool],
    genome: typing.Optional[str],
    bowtie2: typing.Optional[str],
    gtf: typing.Optional[str],
    gene_bed: typing.Optional[str],
    blacklist: typing.Optional[str],
    spikein_bowtie2: typing.Optional[str],
    spikein_fasta: typing.Optional[str],
    fasta: typing.Optional[LatchFile],
    only_input: typing.Optional[bool],
    only_genome: typing.Optional[bool],
    only_preqc: typing.Optional[bool],
    only_alignment: typing.Optional[bool],
    only_filtering: typing.Optional[bool],
    only_peak_calling: typing.Optional[bool],
    skip_fastqc: typing.Optional[bool],
    skip_trimming: typing.Optional[bool],
    skip_removeduplicates: typing.Optional[bool],
    skip_reporting: typing.Optional[bool],
    skip_preseq: typing.Optional[bool],
    skip_igv: typing.Optional[bool],
    skip_dt_qc: typing.Optional[bool],
    skip_heatmaps: typing.Optional[bool],
    skip_peak_qc: typing.Optional[bool],
    skip_multiqc: typing.Optional[bool],
    remove_mitochondrial_reads: typing.Optional[bool],
    mito_name: typing.Optional[str],
    dedup_target_reads: typing.Optional[bool],
    remove_linear_duplicates: typing.Optional[bool],
    macs2_pvalue: typing.Optional[float],
    singularity_pull_docker_container: typing.Optional[bool],
    ...
    dt_calc_all_matrix: typing.Optional[bool],
    min_frip_overlap: typing.Optional[float],
    min_peak_overlap: typing.Optional[float],
    igv_sort_by_groups: typing.Optional[bool],
) -> None:
    try:
...
def nf_nf_core_cutandrun(
    ...
    end_to_end: typing.Optional[bool] = True,
    ...
    use_control: typing.Optional[bool] = True,
    extend_fragments: typing.Optional[bool] = True,
    ...
    macs2_narrow_peak: typing.Optional[bool] = True,
    ...
    igv_show_gene_names: typing.Optional[bool] = True,
    ...
    dt_calc_all_matrix: typing.Optional[bool] = True,
    min_frip_overlap: typing.Optional[float] = 0.2,
    min_peak_overlap: typing.Optional[float] = 0.2,
    igv_sort_by_groups: typing.Optional[bool] = True,
) -> None:
    """
    nf-core/cutandrun
