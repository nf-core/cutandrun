...
include { DEEPTOOLS_COMPUTEMATRIX as DEEPTOOLS_COMPUTEMATRIX_GENE      } from "../modules/nf-core/deeptools/computematrix"
include { DEEPTOOLS_COMPUTEMATRIX as DEEPTOOLS_COMPUTEMATRIX_GENE_ALL  } from "../modules/nf-core/deeptools/computematrix"
include { DEEPTOOLS_COMPUTEMATRIX as DEEPTOOLS_COMPUTEMATRIX_PEAKS     } from "../modules/nf-core/deeptools/computematrix"
include { DEEPTOOLS_COMPUTEMATRIX as DEEPTOOLS_COMPUTEMATRIX_PEAKS_ALL } from "../modules/nf-core/deeptools/computematrix"
include { DEEPTOOLS_PLOTHEATMAP as DEEPTOOLS_PLOTHEATMAP_GENE          } from "../modules/nf-core/deeptools/plotheatmap"
include { DEEPTOOLS_PLOTHEATMAP as DEEPTOOLS_PLOTHEATMAP_GENE_ALL      } from "../modules/nf-core/deeptools/plotheatmap"
include { DEEPTOOLS_PLOTHEATMAP as DEEPTOOLS_PLOTHEATMAP_PEAKS         } from "../modules/nf-core/deeptools/plotheatmap"
include { DEEPTOOLS_PLOTHEATMAP as DEEPTOOLS_PLOTHEATMAP_PEAKS_ALL     } from "../modules/nf-core/deeptools/plotheatmap"
include { MACS2_CALLPEAK as MACS2_CALLPEAK_IGG                         } from "../modules/nf-core/macs2/callpeak"
include { MACS2_CALLPEAK as MACS2_CALLPEAK_NOIGG                       } from "../modules/nf-core/macs2/callpeak"
include { MULTIQC                                                      } from '../modules/nf-core/multiqc'
include { PRESEQ_LCEXTRAP                                              } from "../modules/nf-core/preseq/lcextrap"
include { SEACR_CALLPEAK as SEACR_CALLPEAK_IGG                         } from "../modules/nf-core/seacr/callpeak"
include { SEACR_CALLPEAK as SEACR_CALLPEAK_NOIGG                       } from "../modules/nf-core/seacr/callpeak"

/*
 * FUNCTIONS
 */

include { methodsDescriptionText                                       } from '../subworkflows/local/utils_nfcore_cutandrun_pipeline'
...
workflow CUTANDRUN {
    ...
    def frag_len_header_mqc = file("${projectDir}/assets/multiqc/frag_len_header.txt", checkIfExists: true)
    def frip_score_header_mqc = file("${projectDir}/assets/multiqc/frip_score_header.txt", checkIfExists: true)
    def linear_duplication_header_mqc = file("${projectDir}/assets/multiqc/linear_duplication_header.txt", checkIfExists: true)
    def peak_counts_consensus_header_mqc = file("${projectDir}/assets/multiqc/peak_counts_consensus_header.txt", checkIfExists: true)
    def peak_counts_header_mqc = file("${projectDir}/assets/multiqc/peak_counts_header.txt", checkIfExists: true)
    def peak_reprod_header_mqc = file("${projectDir}/assets/multiqc/peak_reprod_header.txt", checkIfExists: true)
    ...
    */
    ...
    if (params.aligner == "bowtie2" && params.run_alignment) {
        ...
        ch_versions = ch_versions.mix(EXTRACT_BT2_TARGET_META.out.versions)
    ...
    */
    ...
    if (params.run_remove_dups) {
        ...
        ch_versions = ch_versions.mix(DEDUPLICATE_PICARD.out.versions)
    ...
    */
    ...
    if (params.run_mark_dups) {
        ...
        ch_versions = ch_versions.mix(EXTRACT_PICARD_DUP_META.out.versions)
    }
    ...
    if (params.run_remove_linear_dups) {
        ...
        ch_versions = ch_versions.mix(DEDUPLICATE_LINEAR.out.versions)
    ...
    if (params.run_peak_calling) {
        ...
        */
        ...
        ch_versions = ch_versions.mix(PREPARE_PEAKCALLING.out.versions)
        ...
        */
        ...
        if (params.use_control) {
            ...
            */
            if ('seacr' in callers) {
                ...
                */
                ch_bedgraph_control
                    .map { row -> [row[0].control_group + "_" + row[0].replicate, row] }
            ...
            if ('macs2' in callers) {
                ...
                */
                ...
                ch_versions = ch_versions.mix(MACS2_CALLPEAK_IGG.out.versions)
            }
        }
        else {
            /*
            ...
            */
            ...
            if ('macs2' in callers) {
                ...
                */
                ...
                ch_versions = ch_versions.mix(MACS2_CALLPEAK_NOIGG.out.versions)
            }
        }
        ...
        if ("macs2" in callers) {
            ...
            */
            ...
            ch_versions = ch_versions.mix(PEAK_TO_BED.out.versions)
        }
        ...
        if ('seacr' in callers) {
            ...
            */
            ...
            ch_versions = ch_versions.mix(AWK_EXTRACT_SUMMITS.out.versions)
        }
        ...
        */
        ...
        ch_versions = ch_versions.mix(AWK_NAME_PEAK_BED.out.versions)
        ...
        if (params.run_consensus_all) {
            ...
            */
            ...
            ch_versions = ch_versions.mix(CONSENSUS_PEAKS_ALL.out.versions)
        }
        else {
            /*
    ...
    if (params.run_reporting) {
        if (params.run_igv) {
            ...
            */
            ...
            ch_versions = ch_versions.mix(IGV_SESSION.out.versions)
        }
        ...
        if (params.run_deeptools_heatmaps && params.run_peak_calling) {
            ...
            */
            ...
            ch_versions = ch_versions.mix(DEEPTOOLS_COMPUTEMATRIX_GENE.out.versions)
            ...
            */
            ...
            ch_versions = ch_versions.mix(DEEPTOOLS_PLOTHEATMAP_GENE.out.versions)
            ...
            */
            ...
            ch_versions = ch_versions.mix(DEEPTOOLS_COMPUTEMATRIX_PEAKS.out.versions)
            ...
            */
            ...
            ch_versions = ch_versions.mix(DEEPTOOLS_PLOTHEATMAP_PEAKS.out.versions)
        ...
        if (params.run_peak_qc && params.run_peak_calling) {
            ...
            */
            PEAK_QC(
                ...
                frip_score_header_mqc,
                peak_counts_header_mqc,
                peak_counts_consensus_header_mqc,
                peak_reprod_header_mqc,
            )
            ch_versions = ch_versions.mix(PEAK_QC.out.versions)
        ...
        */
        ...
        ch_versions = ch_versions.mix(FRAG_LEN_HIST.out.versions)
    ...
    if (params.run_multiqc) {
        ...
        softwareVersionsToYAML(ch_versions)
            .collectFile(storeDir: "${params.outdir}/pipeline_info", name: 'nf_core_cutandrun_software_mqc_versions.yml', sort: true, newLine: true)
