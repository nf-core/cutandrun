...
[![GitHub Actions CI Status](https://github.com/nf-core/cutandrun/actions/workflows/ci.yml/badge.svg)](https://github.com/nf-core/cutandrun/actions/workflows/ci.yml)
...
nf-core/cutandrun was originally written by Chris Cheshire ([@chris-cheshire](https://github.com/chris-cheshire)), Charlotte West ([@charlotte-west](https://github.com/charlotte-west)) from [Luscombe Lab](https://www.crick.ac.uk/research/labs/nicholas-luscombe) at [The Francis Crick Institute](https://www.crick.ac.uk/), London, UK and Tamara Hodgetts ([@tamara-hodgetts](https://github.com/tamara-hodgetts)) from the [Fröhlich Lab](https://www.crick.ac.uk/research/labs/fabian-frohlich) at [The Francis Crick Institute](https://www.crick.ac.uk/), London, UK.
