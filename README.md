...
For more details, please refer to the [usage documentation](https://nf-co.re/cutandrun/usage) and the [parameter documentation](https://nf-co.re/cutandrun/parameters).
