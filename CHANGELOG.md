...
- [[#53](https://github.com/nf-core/cutandrun/issues/53)] - Complete redesign of the samplesheet input system. Controls are no longer hard-coded to `igg` and the process of assigning controls to samples has be simplified.
...
- [[#95](https://github.com/nf-core/cutandrun/issues/95)] - Fixed FRIP performance issues and crashes.
